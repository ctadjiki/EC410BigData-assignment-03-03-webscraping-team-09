...
#
#6.2 Waiting on clarification from Garret
#
#6.3
# 7.1 figure out how to change country code to a countable number
# 7.2
```
...
world_plot = 
  ggplot(joined_tibble) +
  geom_sf(aes(geometry = geometry,fill = country), alpha=0.8, col="white") +
  ggtitle("Fastest Times by Country") + scale_fill_viridis_c(name = "country")
world_plot

world_plot2 = 
  ggplot(joined_tibble) +
  geom_sf(aes(geometry = geometry, color = athlete), alpha=0.8, col="white") +
  ggtitle("Fastest Times by Country") + scale_fill_viridis_c(name = "athlete")
world_plot2
```
