...
$\beta_0 = 10.094$ and $\beta_1 = -0.00002}$  
...
b0 = 10.094
b1 =  -0.00002
time_exp = b0+b1*(as.numeric(2009-08-16)) #expected WR when current was set
#9.58 = b0+b1*(year_exp)
year_exp = (9.58-b0)/b1
time_exp  #expected WR when current was set
year_exp #year expected to reach 9.58

# The expected time shouldn't be above 10 second by 2009. I think that's a bit slow. Could be a rounding error. 
```
