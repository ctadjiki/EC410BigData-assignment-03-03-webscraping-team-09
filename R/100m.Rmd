...
list <-
  ...
  html_text(list) 
#This isn't working I might need to write a function. I started it below from the Craigslist example. 
  
list
```

## Converting to a data frame with function
```{r}
#I'm not sure if this is the answer to crating a data frame just a thought. 
m100_wp <-
  rbindlist(lapply(
    seq_along(n),
    function(i) {
      ...
      data.table(t(m100_wp[start:end]))
    }
  ), fill = TRUE)
